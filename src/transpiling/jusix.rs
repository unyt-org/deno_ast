use swc_common::{util::take::Take, DUMMY_SP, Span};
use swc_ecma_ast::{Ident, ArrowExpr, JSXEmptyExpr, JSXExpr, JSXExprContainer, BlockStmtOrExpr, Expr, CallExpr, Callee, ExprOrSpread, Lit, Null};
