...
use swc_ecma_ast::{
  ArrowExpr, BlockStmtOrExpr, CallExpr, Callee, Expr, ExprOrSpread, Ident,
  JSXEmptyExpr, JSXExpr, JSXExprContainer, Lit, Null,
};
    ...
    JSXExprContainer {
      ...
      expr: (match n.expr {
        ...
        JSXExpr::JSXEmptyExpr(_) => {
          JSXExpr::JSXEmptyExpr(JSXEmptyExpr { span: DUMMY_SP })
        }
      }),
    }
  }
